#!/usr/bin/env bash
# final-3xui-debian12-1c1g-vps-tuning-v5.sh
# Target: Debian 12 (Bookworm), Linux 6.1+, 1 vCPU, about 1 GiB RAM.
...
check_supported_os() {
  ...
  fail "This profile is only for Debian 12. Set ALLOW_UNSUPPORTED_OS=1 only after manual review."
}
...
show_environment() {
  ...
  warn "Debian 12 entered LTS in July 2026; keep security and LTS updates enabled."
}
...
# Conservative tuning for Debian 12, 1 vCPU, about 1 GiB RAM,
